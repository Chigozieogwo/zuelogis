...
const TrackEditScreen = ({ match, history }) => {
  ...
  const [location_history, setLocation_history] = useState('')
  const [status_history, setStatus_history] = useState('')
  ...
  const submitHistoryHandler = (e) => {
    ...
    dispatch(trackHistoryAction({ data_history,location_history,status_history,comment}))
    setShow(false)
  }
                ...
                {/* <Col md={6} sm={12}>
                  <Form.Group controlId="date">
                    ...
                    <Form.Control
                      ...
                      placeholder="Date"
                      value={data_history}
                      onChange={(e) => setData_history(e.target.value)}></Form.Control>
                  </Form.Group>
                </Col> */}
                <Col md={6} sm={12}>
                  <Form.Group controlId="data_history">
                    <Form.Label>Date</Form.Label>
                    <Form.Control
                      type="text"
                      placeholder="Date"
                ...
                <Col md={6} sm={12}>
                  <Form.Group controlId="location">
                    ...
                    <Form.Control
                      ...
                      onChange={(e) => setLocation_history(e.target.value)}></Form.Control>
                  </Form.Group>
                </Col>
                <Col md={6} sm={12}>
                  <Form.Group controlId="status2">
                    ...
                    <Form.Control
                      ...
                      onChange={(e) =>
                        setStatus_history(e.target.value)
                      }></Form.Control>
                  </Form.Group>
                </Col>
                <Col md={6} sm={12}>
...
<div className="d-flex justify-content-sm-between ">
        <Link onClick={resetHandler} to="/admin/tracklist" className="btn btn-primary me-2 my-3"> Go Back </Link>
        <Link onClick={handleShow}  className="btn btn-primary  my-3"> Add Shipment History </Link>
